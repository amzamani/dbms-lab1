...
// CREATE ROUTE - BLOGS modified
// const addOne = (req, res) => {
//     let insertQuery = 'INSERT INTO blogs(title,image_url,body,user_id) VALUES(?,?,?,?);';
//     // let params = [req.body.title, req.file.filename, req.body.blog.body, req.user.id];
//     let params = [req.body.title, null, null, null];
...
const addOne = (req, res) => {
    let insertQuery = 'INSERT INTO blogs(title,image_url,body,user_id) VALUES(?,?,?,?);';
    console.log("bongop akf" + " " +req.body);
    const {postfo,bodyfo} = req.body;
    const imgstr = "asd"
    let newBlogParam ={
        // blogTitle : req.body.postfo,
        // // blogFilename : req.file.imgfo,
        // blogBody : req.body.blog.bodyfo,
        // userID : req.user.id
        blogTitle : postfo,
        blogBody : bodyfo,
        userID : req.user.id,
    ...
    console.log(newBlogParam)
    let params = [newBlogParam.blogTitle,newBlogParam.img,newBlogParam.blogBody, req.user.id];
